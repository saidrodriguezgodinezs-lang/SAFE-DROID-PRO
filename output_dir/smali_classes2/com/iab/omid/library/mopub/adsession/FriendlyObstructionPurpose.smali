...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;

    const-string v3, "CLOSE_AD"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;->CLOSE_AD:Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;

    new-instance v3, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;

    const-string v5, "NOT_VISIBLE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;->NOT_VISIBLE:Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;

    new-instance v5, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;

    const-string v7, "OTHER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;->OTHER:Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;
    ...
    sput-object v7, Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;->$VALUES:[Lcom/iab/omid/library/mopub/adsession/FriendlyObstructionPurpose;
