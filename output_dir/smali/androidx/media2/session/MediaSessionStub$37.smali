...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/media2/session/MediaSessionStub;->subscribe(Landroidx/media2/session/IMediaController;ILjava/lang/String;Landroidx/versionedparcelable/ParcelImpl;)V
.end annotation
...
.method constructor <init>(Landroidx/media2/session/MediaSessionStub;Ljava/lang/String;Landroidx/versionedparcelable/ParcelImpl;)V
    ...
    iput-object p2, p0, Landroidx/media2/session/MediaSessionStub$37;->val$parentId:Ljava/lang/String;

    iput-object p3, p0, Landroidx/media2/session/MediaSessionStub$37;->val$libraryParams:Landroidx/versionedparcelable/ParcelImpl;
...
.method public run(Landroidx/media2/session/MediaSession$ControllerInfo;)Ljava/lang/Integer;
    ...
    .line 1127
    iget-object v0, p0, Landroidx/media2/session/MediaSessionStub$37;->val$parentId:Ljava/lang/String;
    ...
    const-string/jumbo v1, "subscribe(): Ignoring empty parentId from "
    ...
    iget-object v1, p0, Landroidx/media2/session/MediaSessionStub$37;->val$parentId:Ljava/lang/String;

    iget-object v2, p0, Landroidx/media2/session/MediaSessionStub$37;->val$libraryParams:Landroidx/versionedparcelable/ParcelImpl;
    ...
    .line 1131
    invoke-interface {v0, p1, v1, v2}, Landroidx/media2/session/MediaLibraryService$MediaLibrarySession$MediaLibrarySessionImpl;->onSubscribeOnExecutor(Landroidx/media2/session/MediaSession$ControllerInfo;Ljava/lang/String;Landroidx/media2/session/MediaLibraryService$LibraryParams;)I
...
.method public bridge synthetic run(Landroidx/media2/session/MediaSession$ControllerInfo;)Ljava/lang/Object;
    ...
    .line 1124
    invoke-virtual {p0, p1}, Landroidx/media2/session/MediaSessionStub$37;->run(Landroidx/media2/session/MediaSession$ControllerInfo;)Ljava/lang/Integer;
