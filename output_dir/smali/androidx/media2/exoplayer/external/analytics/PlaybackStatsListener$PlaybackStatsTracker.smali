...
.method public constructor <init>(ZLandroidx/media2/exoplayer/external/analytics/AnalyticsListener$EventTime;)V
    ...
    .line 497
    iget-object v1, p2, Landroidx/media2/exoplayer/external/analytics/AnalyticsListener$EventTime;->mediaPeriodId:Landroidx/media2/exoplayer/external/source/MediaSource$MediaPeriodId;
...
.method private maybeRecordAudioFormatTime(J)V
    ...
    .line 974
    iget-wide v0, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->lastAudioFormatStartTimeMs:J

    sub-long v0, p1, v0

    long-to-float v0, v0

    iget v1, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->currentPlaybackSpeed:F
    ...
    .line 975
    iget-wide v2, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->audioFormatTimeMs:J

    add-long/2addr v2, v0

    iput-wide v2, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->audioFormatTimeMs:J

    .line 976
    iget-wide v2, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->audioFormatBitrateTimeProduct:J

    iget-object v4, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->currentAudioFormat:Landroidx/media2/exoplayer/external/Format;
    ...
    iput-wide v2, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->audioFormatBitrateTimeProduct:J
...
.method private maybeUpdateAudioFormat(Landroidx/media2/exoplayer/external/analytics/AnalyticsListener$EventTime;Landroidx/media2/exoplayer/external/Format;)V
    ...
    .line 950
    iget-object v0, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->audioFormatHistory:Ljava/util/List;
...
.method private maybeUpdatePlaybackState(Landroidx/media2/exoplayer/external/analytics/AnalyticsListener$EventTime;Z)V
    ...
    .line 801
    iget-object v3, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->playbackStateDurationsMs:[J

    iget v4, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->currentPlaybackState:I
    ...
    .line 802
    iget-wide v1, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->firstReportedTimeMs:J
    ...
    .line 825
    iget-wide v3, p1, Landroidx/media2/exoplayer/external/analytics/AnalyticsListener$EventTime;->eventPlaybackPositionMs:J

    .line 823
    :cond_8
    invoke-direct {p0, v1, v2, v3, v4}, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->maybeUpdateMediaTimeHistory(JJ)V
...
.method private maybeUpdateVideoFormat(Landroidx/media2/exoplayer/external/analytics/AnalyticsListener$EventTime;Landroidx/media2/exoplayer/external/Format;)V
    ...
    .line 934
    iget-object v0, p0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->videoFormatHistory:Ljava/util/List;
...
.method public build(Z)Landroidx/media2/exoplayer/external/analytics/PlaybackStats;
    ...
    .line 776
    iget v8, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->initialVideoFormatHeight:I
    ...
    .line 777
    :goto_8
    iget-wide v8, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->initialVideoFormatBitrate:J
    ...
    .line 780
    :goto_9
    iget-wide v8, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->initialAudioFormatBitrate:J
    ...
    .line 786
    iget v8, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->fatalErrorCount:I
    ...
    :goto_b
    iget v9, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->nonFatalErrorCount:I

    move/from16 v60, v9

    iget-object v9, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->fatalErrorHistory:Ljava/util/List;

    move-object/from16 v61, v9

    iget-object v9, v0, Landroidx/media2/exoplayer/external/analytics/PlaybackStatsListener$PlaybackStatsTracker;->nonFatalErrorHistory:Ljava/util/List;
