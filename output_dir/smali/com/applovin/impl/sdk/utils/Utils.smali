...
.method public static checkCachedResourcesExist(ZLcom/applovin/impl/sdk/a/g;Lcom/applovin/impl/sdk/k;Landroid/content/Context;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/a/g;->A()Ljava/util/List;
    ...
    invoke-virtual {p2}, Lcom/applovin/impl/sdk/k;->Y()Lcom/applovin/impl/sdk/p;
    ...
    invoke-virtual {v4, v3, v5}, Lcom/applovin/impl/sdk/r;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/a/g;->h()Landroid/net/Uri;
    ...
    invoke-virtual {p1, v3, p2}, Lcom/applovin/impl/sdk/r;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static checkExoPlayerEligibility(Lcom/applovin/impl/sdk/k;)Z
    .locals 3
    ...
    invoke-virtual {p0, v2}, Lcom/applovin/impl/sdk/k;->a(Lcom/applovin/impl/sdk/c/b;)Ljava/lang/Object;
...
.method public static close(Ljava/io/Closeable;Lcom/applovin/impl/sdk/k;)V
    .locals 3
    ...
    invoke-virtual {p1, v1, p0, v0}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static disconnect(Ljava/net/HttpURLConnection;Lcom/applovin/impl/sdk/k;)V
    .locals 3
...
.method private static generateClassesList(Ljava/util/List;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v5}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v7}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/k;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v5}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v6}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/k;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/k;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p6}, Lcom/applovin/impl/sdk/k;->z()Lcom/applovin/impl/sdk/r;
...
.method public static getServerAdjustedUnixTimestampMillis(Lcom/applovin/impl/sdk/k;)J
    .locals 8
...
.method public static getZone(Lorg/json/JSONObject;Lcom/applovin/impl/sdk/k;)Lcom/applovin/impl/sdk/a/d;
    .locals 3
    ...
    invoke-static {p1, v1, p0}, Lcom/applovin/impl/sdk/a/d;->a(Lcom/applovin/sdk/AppLovinAdSize;Lcom/applovin/sdk/AppLovinAdType;Ljava/lang/String;)Lcom/applovin/impl/sdk/a/d;
...
.method public static hasAndroidCoreJsonLibrary(Lcom/applovin/impl/sdk/k;)Z
    .locals 3
    ...
    invoke-virtual {p0, v1, v2, v0}, Lcom/applovin/impl/sdk/r;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static isAppLovinTestEnvironment(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/applovin/impl/sdk/utils/c;->a(Ljava/lang/String;)Z
...
.method public static isCurrentProcessInForeground()Z
    ...
    invoke-static {v2, v3, v1}, Lcom/applovin/impl/sdk/r;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static maybeHandleNoFillResponseForPublisher(Ljava/lang/String;Lcom/applovin/mediation/MaxAdFormat;Lorg/json/JSONObject;Lcom/applovin/impl/sdk/k;)V
    .locals 2
    ...
    invoke-virtual {p3}, Lcom/applovin/impl/sdk/k;->x()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/applovin/impl/sdk/k;->J()Landroid/content/Context;
    ...
    invoke-static {p1, p0}, Lcom/applovin/impl/sdk/r;->i(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public static maybeRetrieveNonDummyAd(Lcom/applovin/sdk/AppLovinAd;Lcom/applovin/impl/sdk/k;)Lcom/applovin/sdk/AppLovinAd;
    .locals 3

    instance-of v0, p0, Lcom/applovin/impl/sdk/a/h;

    if-eqz v0, :cond_1

    check-cast p0, Lcom/applovin/impl/sdk/a/h;

    invoke-virtual {p1}, Lcom/applovin/impl/sdk/k;->t()Lcom/applovin/impl/sdk/AppLovinAdServiceImpl;

    move-result-object v0

    invoke-virtual {p0}, Lcom/applovin/impl/sdk/a/h;->getAdZone()Lcom/applovin/impl/sdk/a/d;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/applovin/impl/sdk/AppLovinAdServiceImpl;->dequeueAd(Lcom/applovin/impl/sdk/a/d;)Lcom/applovin/sdk/AppLovinAd;
    ...
    invoke-virtual {p0, v0}, Lcom/applovin/impl/sdk/a/h;->a(Lcom/applovin/sdk/AppLovinAd;)V

    move-object p1, v0

    check-cast p1, Lcom/applovin/impl/sdk/AppLovinAdBase;

    invoke-virtual {p1, p0}, Lcom/applovin/impl/sdk/AppLovinAdBase;->setDummyAd(Lcom/applovin/impl/sdk/a/h;)V

    return-object v0

    :cond_0
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/a/h;->a()Lcom/applovin/sdk/AppLovinAd;
...
.method public static objectIsOfType(Ljava/lang/Object;Ljava/util/List;Lcom/applovin/impl/sdk/k;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-static {p1, p2}, Lcom/applovin/impl/sdk/utils/Utils;->generateClassesList(Ljava/util/List;Lcom/applovin/impl/sdk/k;)Ljava/util/List;
    ...
    invoke-virtual {p0, v3, p1}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, p1, p2}, Lcom/applovin/impl/sdk/utils/Utils;->objectIsOfType(Ljava/lang/Object;Ljava/util/List;Lcom/applovin/impl/sdk/k;)Z
    ...
    invoke-virtual {p2, v3, p0}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;)V

    return v0
.end method

.method public static openUri(Landroid/content/Context;Landroid/net/Uri;Lcom/applovin/impl/sdk/k;)Z
    .locals 3
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/applovin/impl/sdk/k;->ab()Lcom/applovin/impl/sdk/v;

    move-result-object v1

    invoke-virtual {v1}, Lcom/applovin/impl/sdk/v;->b()V
    ...
    invoke-virtual {v0, v1, p1, p0}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/v;->c()V
...
.method public static retrieveParentActivity(Landroid/view/View;Lcom/applovin/impl/sdk/k;)Landroid/app/Activity;
    .locals 4
    ...
    invoke-virtual {p1, v1, v2, p0}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_3
    return-object v0
.end method

.method public static sanitizeSuperProperty(Ljava/lang/Object;Lcom/applovin/impl/sdk/k;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-static {v1, p1}, Lcom/applovin/impl/sdk/utils/Utils;->sanitizeSuperProperty(Ljava/lang/Object;Lcom/applovin/impl/sdk/k;)Ljava/lang/Object;
    ...
    sget-object p0, Lcom/applovin/impl/sdk/c/b;->bc:Lcom/applovin/impl/sdk/c/b;
    ...
    sget-object p0, Lcom/applovin/impl/sdk/c/b;->bd:Lcom/applovin/impl/sdk/c/b;
...
.method public static toVersionCode(Ljava/lang/String;)I
    ...
    invoke-static {v0, p0}, Lcom/applovin/impl/sdk/r;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static tryParseDouble(Ljava/lang/String;D)D
    ...
    invoke-static {v1, p0, v0}, Lcom/applovin/impl/sdk/r;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static validateAdSdkKey(Lcom/applovin/sdk/AppLovinAd;Lcom/applovin/impl/sdk/k;)V
    .locals 3
