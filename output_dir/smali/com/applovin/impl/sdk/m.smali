...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/applovin/impl/sdk/m;->j:Ljava/util/concurrent/atomic/AtomicReference;
...
.method protected constructor <init>(Lcom/applovin/impl/sdk/k;)V
    ...
    iput-object v0, p0, Lcom/applovin/impl/sdk/m;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object v0, p0, Lcom/applovin/impl/sdk/m;->b:Lcom/applovin/impl/sdk/r;
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->o()Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, Lcom/applovin/impl/sdk/m;->d:Ljava/util/Map;

    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->q()Ljava/util/Map;
...
.method private E()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/applovin/impl/sdk/m;->b:Lcom/applovin/impl/sdk/r;
...
.method private F()Z
    ...
    :try_start_0
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->G()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->H()Z
...
.method private G()Z
    ...
    invoke-direct {p0, v1}, Lcom/applovin/impl/sdk/m;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method private H()Z
    ...
    invoke-direct {p0, v3}, Lcom/applovin/impl/sdk/m;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method static synthetic a(Lcom/applovin/impl/sdk/m;)Ljava/lang/Integer;
    .locals 0

    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->z()Ljava/lang/Integer;
...
.method private a(Ljava/util/Map;Z)Ljava/util/Map;
    ...
    iget-object p1, p0, Lcom/applovin/impl/sdk/m;->c:Landroid/content/Context;

    invoke-static {p1}, Lcom/applovin/impl/sdk/utils/f;->a(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    sget-object p1, Lcom/applovin/impl/sdk/m;->j:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/m;->l()V
    ...
    new-instance p1, Lcom/applovin/impl/sdk/m$a;

    invoke-direct {p1}, Lcom/applovin/impl/sdk/m$a;-><init>()V
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/m;->j()Lcom/applovin/impl/sdk/m$a;

    move-result-object p1

    :goto_0
    iget-object v4, p1, Lcom/applovin/impl/sdk/m$a;->b:Ljava/lang/String;
    ...
    :cond_2
    iget-boolean p1, p1, Lcom/applovin/impl/sdk/m$a;->a:Z
    ...
    invoke-virtual {p1, v4}, Lcom/applovin/impl/sdk/h$a;->a(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    sget-object v4, Lcom/applovin/impl/sdk/c/b;->dC:Lcom/applovin/impl/sdk/c/b;

    invoke-virtual {p1, v4}, Lcom/applovin/impl/sdk/k;->a(Lcom/applovin/impl/sdk/c/b;)Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->t()Lcom/applovin/impl/sdk/m$b;

    move-result-object p1

    iget v4, p1, Lcom/applovin/impl/sdk/m$b;->a:I
    ...
    iget p1, p1, Lcom/applovin/impl/sdk/m$b;->b:I
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->F()Z
    ...
    iget-object p1, p0, Lcom/applovin/impl/sdk/m;->k:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object p2, p0, Lcom/applovin/impl/sdk/m;->b:Lcom/applovin/impl/sdk/r;

    const-string v4, "Unable to collect screen brightness"

    invoke-virtual {p2, v2, v4, p1}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1}, Lcom/applovin/impl/sdk/y;->b(Lcom/applovin/impl/sdk/k;)V
    ...
    invoke-virtual {p2, v2, v0, p1}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, p1}, Lcom/applovin/impl/sdk/utils/f;->a(Ljava/lang/String;Landroid/content/Context;)Z

    move-result p1

    if-eqz p1, :cond_d

    invoke-static {}, Lcom/applovin/impl/sdk/utils/f;->f()Z
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/k;->I()Lcom/applovin/impl/sdk/c/c;

    move-result-object p1

    sget-object p2, Lcom/applovin/impl/sdk/c/b;->dQ:Lcom/applovin/impl/sdk/c/b;

    invoke-virtual {p1, p2}, Lcom/applovin/impl/sdk/c/c;->a(Lcom/applovin/impl/sdk/c/b;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Ljava/lang/String;

    sget-object p2, Lcom/applovin/impl/sdk/m;->h:Ljava/lang/String;
    ...
    :try_start_2
    sput-object p1, Lcom/applovin/impl/sdk/m;->h:Ljava/lang/String;
    ...
    sput p1, Lcom/applovin/impl/sdk/m;->i:I
    :try_end_2
    ...
    :catchall_1
    sput p2, Lcom/applovin/impl/sdk/m;->i:I

    goto :goto_4

    :cond_e
    sget p1, Lcom/applovin/impl/sdk/m;->i:I
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->w()Ljava/lang/String;
    ...
    :cond_f
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->p()Ljava/lang/String;
    ...
    sget-object p2, Lcom/applovin/impl/sdk/c/b;->dR:Lcom/applovin/impl/sdk/c/b;
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/k;->ag()Lcom/applovin/impl/sdk/utils/l;
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/utils/l;->c()F
    ...
    sget-object p2, Lcom/applovin/impl/sdk/c/b;->dS:Lcom/applovin/impl/sdk/c/b;
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/utils/l;->b()F
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/k;->ah()Lcom/applovin/impl/sdk/f;

    move-result-object p1

    invoke-virtual {p1}, Lcom/applovin/impl/sdk/f;->a()I
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->x()Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0}, Lcom/applovin/impl/sdk/m$1;-><init>(Landroid/content/Context;)V
...
.method private a(Ljava/util/Map;)V
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->u()J
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->v()F
    ...
    invoke-static {v0}, Lcom/applovin/impl/sdk/y;->c(Lcom/applovin/impl/sdk/k;)V
    ...
    invoke-static {v0}, Lcom/applovin/impl/sdk/y;->b(Lcom/applovin/impl/sdk/k;)V
    ...
    :cond_5
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->y()Z
...
.method static synthetic b(Landroid/content/Context;)Lcom/applovin/impl/sdk/m$a;
    .locals 0

    invoke-static {p0}, Lcom/applovin/impl/sdk/m;->c(Landroid/content/Context;)Lcom/applovin/impl/sdk/m$a;
...
.method static synthetic b(Lcom/applovin/impl/sdk/m;)Ljava/util/concurrent/atomic/AtomicReference;
    .locals 0

    iget-object p0, p0, Lcom/applovin/impl/sdk/m;->k:Ljava/util/concurrent/atomic/AtomicReference;

    return-object p0
.end method

.method private static c(Landroid/content/Context;)Lcom/applovin/impl/sdk/m$a;
    .locals 4

    invoke-static {}, Lcom/applovin/impl/sdk/m;->s()Z
    ...
    iput-boolean v3, v0, Lcom/applovin/impl/sdk/m$a;->a:Z

    invoke-virtual {p0}, Lcom/google/android/gms/ads/identifier/AdvertisingIdClient$Info;->getId()Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, Lcom/applovin/impl/sdk/m$a;->b:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v2, v1, p0}, Lcom/applovin/impl/sdk/r;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_0
    new-instance p0, Lcom/applovin/impl/sdk/m$a;

    invoke-direct {p0}, Lcom/applovin/impl/sdk/m$a;-><init>()V
...
.method static synthetic m()Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v0, Lcom/applovin/impl/sdk/m;->j:Ljava/util/concurrent/atomic/AtomicReference;
...
.method private n()Ljava/util/Map;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/applovin/impl/sdk/m;->a(Ljava/util/Map;ZZ)Ljava/util/Map;
...
.method private o()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/m;->k()Z
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->A()D
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->E()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/applovin/impl/sdk/utils/f;->a(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-virtual {v1}, Lcom/applovin/impl/sdk/k;->g()Z
    ...
    invoke-virtual {v1}, Lcom/applovin/impl/sdk/k;->p()Lcom/applovin/sdk/AppLovinSdkSettings;
    ...
    :catch_0
    iget-object v2, p0, Lcom/applovin/impl/sdk/m;->b:Lcom/applovin/impl/sdk/r;
    ...
    invoke-virtual {v2, v3, v1}, Lcom/applovin/impl/sdk/r;->e(Ljava/lang/String;Ljava/lang/String;)V

    :cond_1
    :goto_0
    invoke-direct {p0, v0}, Lcom/applovin/impl/sdk/m;->a(Ljava/util/Map;)V
...
.method private q()Ljava/util/Map;
    ...
    iget-object v5, p0, Lcom/applovin/impl/sdk/m;->a:Lcom/applovin/impl/sdk/k;

    invoke-static {v5}, Lcom/applovin/impl/sdk/utils/n;->a(Lcom/applovin/impl/sdk/k;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/applovin/impl/sdk/k;->J()Landroid/content/Context;
    ...
    invoke-virtual {v5, v7}, Lcom/applovin/impl/sdk/k;->a(Lcom/applovin/impl/sdk/c/d;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, v7, v3}, Lcom/applovin/impl/sdk/k;->a(Lcom/applovin/impl/sdk/c/d;Ljava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lcom/applovin/impl/sdk/k;->N()Z
    ...
    invoke-virtual {v3}, Lcom/applovin/impl/sdk/k;->O()Z
...
.method private r()Z
    ...
    invoke-virtual {v2, v3, v4, v0}, Lcom/applovin/impl/sdk/r;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private t()Lcom/applovin/impl/sdk/m$b;
    .locals 5

    new-instance v0, Lcom/applovin/impl/sdk/m$b;

    invoke-direct {v0}, Lcom/applovin/impl/sdk/m$b;-><init>()V
    ...
    iput v3, v0, Lcom/applovin/impl/sdk/m$b;->b:I

    goto :goto_2

    :cond_2
    iput v2, v0, Lcom/applovin/impl/sdk/m$b;->b:I
    ...
    :cond_3
    iput v2, v0, Lcom/applovin/impl/sdk/m$b;->a:I
...
.method private w()Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, Lcom/applovin/impl/sdk/m;->a(I)Ljava/lang/String;
...
.method a()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/applovin/impl/sdk/m;->n()Ljava/util/Map;
    ...
    invoke-static {v1}, Lcom/applovin/impl/sdk/utils/Utils;->getServerAdjustedUnixTimestampMillis(Lcom/applovin/impl/sdk/k;)J
    ...
    invoke-static {v0, v3, v1, v2}, Lcom/applovin/impl/sdk/utils/k;->a(Ljava/lang/String;Ljava/lang/String;J)Ljava/lang/String;
...
.method public a(Ljava/util/Map;ZZ)Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/m;->i()Ljava/util/Map;
    ...
    invoke-virtual {p1}, Lcom/applovin/impl/sdk/k;->s()Ljava/lang/String;
...
.method public f()Z
    ...
    iget-boolean v0, p0, Lcom/applovin/impl/sdk/m;->g:Z
...
.method public g()Ljava/util/Map;
    ...
    iget-boolean v1, p0, Lcom/applovin/impl/sdk/m;->g:Z
    ...
    invoke-virtual {v1}, Lcom/applovin/impl/sdk/k;->q()Lcom/applovin/sdk/AppLovinUserSegment;
...
.method public h()Ljava/util/Map;
    ...
    invoke-virtual {v1, v2}, Lcom/applovin/impl/sdk/k;->a(Lcom/applovin/impl/sdk/c/d;)Ljava/lang/Object;
...
.method public i()Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/sdk/k;->P()Lcom/applovin/impl/sdk/network/b;

    move-result-object v0

    invoke-virtual {v0}, Lcom/applovin/impl/sdk/network/b;->a()Lcom/applovin/impl/sdk/network/b$b;
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/sdk/network/b$b;->a()J
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/sdk/network/b$b;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/sdk/network/b$b;->d()J
    ...
    invoke-virtual {v0}, Lcom/applovin/impl/sdk/network/b$b;->c()J
...
.method public j()Lcom/applovin/impl/sdk/m$a;
    .locals 3

    iget-object v0, p0, Lcom/applovin/impl/sdk/m;->c:Landroid/content/Context;

    invoke-static {v0}, Lcom/applovin/impl/sdk/m;->c(Landroid/content/Context;)Lcom/applovin/impl/sdk/m$a;
    ...
    iget-boolean v1, v0, Lcom/applovin/impl/sdk/m$a;->a:Z
    ...
    iput-object v1, v0, Lcom/applovin/impl/sdk/m$a;->b:Ljava/lang/String;

    :cond_0
    sget-object v1, Lcom/applovin/impl/sdk/m;->j:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_0
    iget-object v1, v0, Lcom/applovin/impl/sdk/m$a;->b:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/applovin/impl/sdk/m;->g:Z
...
.method public k()Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/applovin/impl/sdk/m;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public l()V
    ...
    new-instance v3, Lcom/applovin/impl/sdk/m$2;

    invoke-direct {v3, p0}, Lcom/applovin/impl/sdk/m$2;-><init>(Lcom/applovin/impl/sdk/m;)V

    invoke-direct {v1, v2, v3}, Lcom/applovin/impl/sdk/e/f;-><init>(Lcom/applovin/impl/sdk/k;Lcom/applovin/impl/sdk/e/f$a;)V
    ...
    invoke-direct {v3, p0}, Lcom/applovin/impl/sdk/m$3;-><init>(Lcom/applovin/impl/sdk/m;)V

    const/4 v4, 0x1

    invoke-direct {v1, v2, v4, v3}, Lcom/applovin/impl/sdk/e/y;-><init>(Lcom/applovin/impl/sdk/k;ZLjava/lang/Runnable;)V
